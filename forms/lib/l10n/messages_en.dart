...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function>{
        ...
        "validationExactLengthError": MessageLookupByLibrary.simpleMessage(
            "Length should be equal to {length}"),
        "validationMinLengthError": MessageLookupByLibrary.simpleMessage(
            "Field should have at least {length} characters"),
        "validationWordCountError": MessageLookupByLibrary.simpleMessage(
            "Field should have at least {length} words"),
